...
function PricingPage() {
  ...
  const handlePlanClick = (plan, rate ,choseplan ) => {
  ...
  return (
    <>
      ...
      <div className={styles.head}>
        <h1 style={{fontFamily:"nunito sans"}}>Find Your Ideal Plan with Us</h1>
      ...
      <div className={styles.price}>
        <div className={styles.plan}>
          <div className={`${styles.planMob} ${selectedPlan === "free" ? styles.selectedPlan : ""}`}>
            <h2 style={{fontFamily:"nunito sans"}} 
          ...
          <div className={`${styles.planMob} ${selectedPlan === "bronze" ? styles.selectedPlan : ""}`}>
            <h2 style={{fontFamily:"nunito sans"}}
              className={styles.planMob}
          ...
          <div className={`${styles.planMob} ${selectedPlan === "silver" ? styles.selectedPlan : ""}`}>
            <h2 style={{fontFamily:"nunito sans"}}
              className={styles.planMob}
          ...
          <div  className={`${styles.planMob} ${selectedPlan === "gold" ? styles.selectedPlan : ""}`} >
            <h2 style={{fontFamily:"nunito sans"}}
              className={styles.planMob}
